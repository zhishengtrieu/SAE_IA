...
public class Partie2_1
{
    public static void main(String[] args) throws IOException {
        // Charger les données
        Donnees trainData = new ChargementData("perceptron/data/nombres/train-images.idx3-ubyte", "perceptron/data/nombres/train-labels.idx1-ubyte", 1000).donnees;
        Donnees testData = new ChargementData("perceptron/data/nombres/t10k-images.idx3-ubyte", "perceptron/data/nombres/t10k-labels.idx1-ubyte", 1000).donnees;
